 ...
 */
public class NaiveNeighborsCommandTest {
  ...
  public void testRun() {
    ...
    NaiveNeighborsCommand command = new NaiveNeighborsCommand(stars8);
    ...
    command = new NaiveNeighborsCommand(stars8);
    args = new String[5];
    args[0] = "naive_neighbors";
    args[1] = "3";
    args[2] = "0";
    ...
    results = command.getResults();
    assertEquals("ERROR: incorrect number of arguments for naive_neighbors method", err);
