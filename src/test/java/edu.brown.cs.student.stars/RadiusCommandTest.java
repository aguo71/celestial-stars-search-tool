 ...
 */
public class RadiusCommandTest {
  ...
  public void testRun() {
    ...
    RadiusCommand command = new RadiusCommand(starTree, stars8);
    ...
    command = new RadiusCommand(starTree, stars8);
    args = new String[5];
    args[0] = "naive_radius";
    args[1] = "3";
    args[2] = "0";
    ...
    assertEquals("ERROR: incorrect number of arguments for radius method", err);
