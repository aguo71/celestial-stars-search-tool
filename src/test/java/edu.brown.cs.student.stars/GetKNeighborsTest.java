...
/**
 * Class to test GetKNeighbors.
 */
public class GetKNeighborsTest {
  ...
  public void testRun() {
    ...
    GetKNeighbors<Star> algorithm = new GetKNeighbors<>(neighbors, target, 0);
    ...
    algorithm = new GetKNeighbors<>(neighbors, target, 2);
    ...
    algorithm = new GetKNeighbors<>(neighbors, target, 6);
    neighbors.clear();
    ...
    algorithm = new GetKNeighbors<>(neighbors, target, 4);
    neighbors.clear();
    ...
    algorithm = new GetKNeighbors<>(neighbors, target, 5);
    neighbors.clear();
    ...
    algorithm = new GetKNeighbors<>(neighbors, target, 6);
    neighbors.clear();
    List<Star> stars9 = new ArrayList<>();
    stars9.add(test1);
    stars9.add(test2);
    stars9.add(test3);
    stars9.add(test4);
    stars9.add(test5);
    stars9.add(test6);
    KDTree<Star> tree9 = builder.buildTree(stars9, 0);
    algorithm.run(tree9);
    assertTrue(neighbors.containsKey(0.0));
    assertTrue(neighbors.containsKey(1.0));
    assertTrue(neighbors.containsKey(2.0));
