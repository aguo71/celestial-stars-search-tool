...
<#--  displays 4 forms calling corresponding algorithms -->
  <div class = "formStyle"><div class = "formHeader">Naive Neighbors</div>
    <div class = "formDesc">Find nearest neighbors using a naive algorithm.</div>
    <div>
    <form method="POST" action="/naive_neighbors">
      ...
      <label for="searchCriteria1">Enter name of star in quotes or coordinate to search from: <br>
  ...
  <div class = "formStyle"><div class = "formHeader">KDTree Neighbors</div>
    <div class = "formDesc">Find nearest neighbors using an efficient algorithm.</div>
    <div>
    <form method="POST" action="/neighbors">
      ...
      <label for="searchCriteria2">Enter name of star in quotes or coordinate to search from: <br>
        (format: "Sol" or 0 0 0): </label><br>
  ...
  <div class = "formStyle"><div class = "formHeader">Naive Radius</div>
    ...
    <div>
      ...
      <label for="searchCriteria3">Enter name of star in quotes or coordinate to search from: <br>
        (format: "Sol" or 0 0 0): </label><br>
  ...
  <div class = "formStyle"><div class = "formHeader">KDTree Radius</div>
    ...
    <div>
      ...
      <label for="searchCriteria4">Enter name of star in quotes or coordinate to search from: <br>
        (format: "Sol" or 0 0 0): </label><br>
