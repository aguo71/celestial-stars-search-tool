 ...
 */
public class NaiveRadiusHandler implements TemplateViewRoute {
   ...
   */
  public NaiveRadiusHandler(StarsUniverse universe) {
  ...
  public ModelAndView handle(Request req, Response res) {
    ...
    String radiusDist = qm.value("radiusNaiveDist");
    ...
    // computes algorithm
    String err = universe.guiQNaiveRadius(args);
